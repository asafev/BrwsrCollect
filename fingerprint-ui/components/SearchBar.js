...
export function createSearchBar(onSearch, options = {}) {
    ...
    searchBar.className = 'fp-search-bar';
    ...
    searchBar.innerHTML = `
        <div class="fp-search-bar__main">
            <div class="fp-search-bar__input-wrapper">
                <svg class="fp-search-bar__icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="fp-search-bar__actions">
                <button class="fp-search-bar__toggle" id="fp-search-advanced-toggle" aria-label="Toggle advanced filters">
        ...
        ${showQuickFilters ? `
        <div class="fp-search-bar__quick-filters" id="fp-quick-filters">
            <div class="fp-search-bar__quick-filters-label">Quick Filters:</div>
            <div class="fp-search-bar__filter-chips">
                <button class="fp-filter-chip" data-filter="risk:high" aria-label="Filter high risk metrics">
                    <span class="fp-filter-chip__icon">🚨</span>
                    <span>High Risk</span>
                </button>
                <button class="fp-filter-chip" data-filter="risk:medium" aria-label="Filter medium risk metrics">
                    <span class="fp-filter-chip__icon">⚠️</span>
                    <span>Medium Risk</span>
                </button>
                <button class="fp-filter-chip" data-filter="risk:low" aria-label="Filter low risk metrics">
                    <span class="fp-filter-chip__icon">💡</span>
                    <span>Low Risk</span>
                </button>
                <button class="fp-filter-chip" data-filter="category:automation" aria-label="Filter automation metrics">
                    <span class="fp-filter-chip__icon">🤖</span>
                    <span>Automation</span>
                </button>
                <button class="fp-filter-chip" data-filter="category:security" aria-label="Filter security metrics">
                    <span class="fp-filter-chip__icon">🔒</span>
                    <span>Security</span>
                </button>
            </div>
        ...
        ` : ''}
        ${showAdvancedFilters ? `
        <div class="fp-search-bar__advanced" id="fp-search-advanced" style="display: none;">
            <div class="fp-search-bar__advanced-content">
                <div class="fp-search-bar__filter-group">
                    <label class="fp-search-bar__filter-label">Search In:</label>
                    <div class="fp-search-bar__checkbox-group">
                        <label class="fp-checkbox-label">
                            <input type="checkbox" class="fp-checkbox" data-search-field="name" checked>
                            <span>Metric Names</span>
                        </label>
                        <label class="fp-checkbox-label">
                            <input type="checkbox" class="fp-checkbox" data-search-field="value" checked>
                            <span>Values</span>
                        </label>
                        <label class="fp-checkbox-label">
                            <input type="checkbox" class="fp-checkbox" data-search-field="description" checked>
                            <span>Descriptions</span>
                        </label>
                        <label class="fp-checkbox-label">
                            <input type="checkbox" class="fp-checkbox" data-search-field="category" checked>
                            <span>Categories</span>
                        </label>
                    </div>
                </div>
                <div class="fp-search-bar__filter-group">
                    <label class="fp-search-bar__filter-label">Risk Level:</label>
                    <div class="fp-search-bar__checkbox-group">
                        <label class="fp-checkbox-label">
                            <input type="checkbox" class="fp-checkbox" data-filter-risk="high" checked>
                            <span>High</span>
                        </label>
                        <label class="fp-checkbox-label">
                            <input type="checkbox" class="fp-checkbox" data-filter-risk="medium" checked>
                            <span>Medium</span>
                        </label>
                        <label class="fp-checkbox-label">
                            <input type="checkbox" class="fp-checkbox" data-filter-risk="low" checked>
                            <span>Low</span>
                        </label>
                        <label class="fp-checkbox-label">
                            <input type="checkbox" class="fp-checkbox" data-filter-risk="none" checked>
                            <span>N/A</span>
                        </label>
                    </div>
                </div>
        ...
        ` : ''}
        <div class="fp-search-bar__results-info" id="fp-search-results-info" style="display: none;">
            <span class="fp-search-bar__results-count" id="fp-search-results-count">0</span>
